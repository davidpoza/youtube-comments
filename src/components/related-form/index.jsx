...
import { fetchRelatedChannels } from '../../actions/channel-actions';
import withIsMobile from '../../hocs/with-is-mobile';

function RelatedForm(props) {
  ...
  const makeRequest = useCallback(() => {
    if (channelId) {
      fetchRelatedChannels(dispatch, { channelId, token: get(state, 'user.token') });
      setChannelId('');
    }
...
export default withIsMobile(RelatedForm);
